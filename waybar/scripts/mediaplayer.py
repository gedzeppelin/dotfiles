#!/usr/bin/env python3
# Original from https://github.com/Alexays/Waybar/blob/master/resources/custom_modules/mediaplayer.py
...
class PlayerManager:
    ...
    def write_output(self, text, tooltip, player):
        ...
        output = {
            "text": text,
            "tooltip": tooltip,
            # "class": "custom-" + player.props.player_name, -- fuck the opacity
    ...
    def on_metadata_changed(self, player, metadata, _=None):
        ...
        if (
            ...
            track_info = full_track_info = "Advertisement"
        elif artist is not None and title is not None:
            track_info = title
            full_track_info = f"{artist} - {title}"
        else:
            track_info = full_track_info = title
